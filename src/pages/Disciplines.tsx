...
function Disciplines() {
  ...
  const [search, setSearch] = useState<TestByDiscipline[]>([]);
  ...
  return (
    <>
      ...
      >
        ...
        <TermsAccordions categories={categories} terms={terms} search={search} searchText={searchText}/>
      </Box>
    </>
  );
}
